...
if [[ $# -ne 4 ]] ; then
    ...
    echo "bash /home/perinatal-brain-mri-analysis/run-multi-neo-brain-bet-extraction-2026-general.sh [0/1: 0 - no N4 bias correction, 1 - with N4 bias correction] [full_path_to_input_t2w_recon.nii.gz] [full_path_to_folder_for_tmp_processing] [full_path_to_output_label.nii.gz]"
    echo
    echo "------------------------------------------------------------"
    echo
    exit
...
echo "------------------------------------------------------------"
echo
echo " - SCRIPT FOR NEONATAL BRAIN EXTRACTION PROCESSING ... "
echo
echo "------------------------------------------------------------"
echo 
...
w_bet=${src}/models/atunet_bet_brain_neo_3t_general_t2_1lab_best_metric_model.pth
...
${mirtk}/dilate-image ${proc}/bet-lab-pad-crop-t2-128.nii.gz ${proc}/dl-bet-lab-pad-crop-t2-128.nii.gz -iterations 1

${mirtk}/erode-image ${proc}/bet-lab-pad-crop-t2-128.nii.gz ${proc}/dl-bet-lab-pad-crop-t2-128.nii.gz -iterations 1
